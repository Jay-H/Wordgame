...
func _initialize(dict):
	...
	player_two_firebase_id = dict["player_two_firebase_id"]
...
func _reconnect_function(connected_player_array, reconnected_player_array):
	if player_one_firebase_id == connected_player_array[1]:
		p1id = connected_player_array[0]
		p2id = reconnected_player_array[0]
		game_dictionary["Player One ID"] = p1id
		game_dictionary["Player Two ID"] = p2id
	if player_one_firebase_id == reconnected_player_array[1]:
		p1id = reconnected_player_array[0]
		p2id = connected_player_array[0]
		game_dictionary["Player One ID"] = p1id
		game_dictionary["Player Two ID"] = p2id		
